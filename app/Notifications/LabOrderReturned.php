...
/** Ресепшн буцаалт болгож лаб руу явуулсан — лаб ажилтнуудад */
class LabOrderReturned extends Notification
{
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'return_reason' => $this->labOrder->return_reason,
            'return_count' => $this->labOrder->return_count,
        ];
    }
}
