...
## CallPro-гийн зан төлөв — бодит датагаар баталсан (2026-09-23)

Баримт бичигт байхгүй, гэхдээ тохиргоо хийхэд зайлшгүй мэдэх ёстой зүйлс.

### Queue нэр нь IVR-ийн ТОВЧНЫ ДУГААР

```json
{ "number": "80141889", "queue_name": "3" }
```

Дүүргийн нэр биш. 70003931 дээр 3 дарвал `"3"` ирнэ. Тиймээс
`/admin/call-settings` → «IVR товч → салбар» хэсэгт `0`–`4` гэж бүртгэнэ:

| Товч | Салбар |
|---|---|
| 0 | — (мэдээлэл авах, салбаргүй) |
| 1 | Сансар |
| 2 | Хороолол |
| 3 | Цамбагарав |
| 4 | Яармаг |

IVR цэс өөрчлөгдвөл ЗААВАЛ энд шинэчилнэ — эс бөгөөс алдсан дуудлага буруу
салбарт очно.

### Алдсан дуудлаганд `agent` ҮРГЭЛЖ хоосон

CallPro хэн рүү хонх дуугарснаа илгээдэггүй. Дотуур дугаараар салбар олох зам
зөвхөн ХАРИУЛСАН дуудлаганд ажиллана.

### `abandoned` нь зөвхөн дараалалд хүлээсэн үед ирнэ

Товч дарж, дараалалд орж, хүлээгээд тасалсан бол `abandoned` ирнэ (~35 сек
хүлээсэн тест дуудлагаар баталсан). IVR-ийн танилцуулга сонсож байхдаа
тасалсан бол ирэхгүй — тийм дуудлагад салбар гэж БАЙХГҮЙ.

Ийм дуудлага ресепшний «Салбаргүй» харагдацад бүх салбарт нээлттэй орж,
хэн нэг нь «Би авлаа» дарж хариуцна.

### `end` payload-д queue байдаггүй

Үүнийг нэмүүлэх хүсэлтийг CallPro-д илгээсэн (2026-09-23). Хэрэгжвэл товч
дарсан бүх дуудлага — хариулсан ч, алдсан ч — салбартаа унах бөгөөд нэмэлт
код шаардахгүй: одоогийн mapping дээрээ шууд ажиллана.
