...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Хайлт', href: '/reception/appointments/search' },
];
...
/*  Page                                                                */
/* ================================================================== */
export default function ReceptionAppointmentsSearch({ appointments, creatorStats, doctors, creators, filters }: Props) {
    ...
    function doSearch(overrides?: Partial<Record<string, string>>) {
        ...
        router.get('/reception/appointments/search', merged, { preserveState: true, preserveScroll: true });
    }

    function clearAll() {
        setQ(''); setStatus(''); setType(''); setDoctorId(''); setCreatedBy(''); setDateFrom(''); setDateTo('');
        router.get('/reception/appointments/search', {}, { preserveState: false });
    }

    function changeStatus(id: number, newStatus: string) {
        router.patch(`/reception/appointments/${id}/status`, { status: newStatus }, {
            preserveScroll: true,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-col gap-3 p-4">
                ...
                <div className="flex items-center gap-3">
                    <button onClick={() => router.get('/reception/appointments')}
