...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Шинэ үр дүн', href: '/admin/gallery/create' },
];
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-medium">
                                        Өмнөх зураг <span className="text-red-500">*</span>
                                    </label>
                                    <div
                                    ...
                                    >
                                        {beforePreview ? (
                                            ...
                                            <div className="flex flex-col items-center gap-2 p-6 text-center">
                                                ...
                                                <p className="text-xs text-muted-foreground/60">PNG, JPG — 8MB</p>
                                            </div>
                                        )}
                                    </div>
                                    <input
                                    ...
                                    {beforePreview && (
                                        <button
                                            type="button"
                                            onClick={() => { setBeforePreview(null); setData('before_image', null); }}
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-medium">
                                        Дараах зураг <span className="text-red-500">*</span>
                                    </label>
                                    <div
                                    ...
                                    {afterPreview && (
                                        <button
                                            type="button"
                                            onClick={() => { setAfterPreview(null); setData('after_image', null); }}
                                            className="text-xs text-red-500 hover:underline"
                                        >
                                            Зураг хасах
                                        </button>
