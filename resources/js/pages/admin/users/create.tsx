...
interface Props  { branches: Branch[]; roles: Role[] }

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Админ',       href: '/admin/dashboard' },
    { title: 'Хэрэглэгчид', href: '/admin/users' },
    { title: 'Шинэ нэмэх',  href: '/admin/users/create' },
];
...
export default function UserCreate({ branches, roles }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Шинэ хэрэглэгч нэмэх" />
            <div className="flex flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 className="text-xl font-bold">Шинэ хэрэглэгч нэмэх</h1>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        ...
                        <div className="rounded-2xl border bg-card p-5 shadow-sm">
                            <h2 className="mb-4 text-sm font-semibold text-muted-foreground uppercase tracking-wide">Роль сонгох</h2>
                        ...
                        {/* Branch — ресепшн байхад л харагдана */}
                        {isReception && (
                            <div className="rounded-2xl border bg-card p-5 shadow-sm">
                                <h2 className="mb-4 text-sm font-semibold text-muted-foreground uppercase tracking-wide">Салбар оноох</h2>
                                <div className="space-y-1.5">
                                    <label className="text-sm font-medium">Ажиллах салбар</label>
                                    {branches.length === 0 ? (
                                        <p className="rounded-lg bg-amber-50 dark:bg-amber-950/30 px-4 py-3 text-sm text-amber-700 dark:text-amber-300">
                        ...
                        <div className="rounded-2xl border bg-card p-5 shadow-sm space-y-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input type="text" value={data.name} onChange={e => setData('name', e.target.value)}
                                    autoFocus placeholder="Жишээ: Болд Баатар"
                                    className="border-input bg-background w-full rounded-xl border px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 transition-shadow" />
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="email" value={data.email} onChange={e => setData('email', e.target.value)}
                                        placeholder="user@cuticul.mn"
                                        className="border-input bg-background w-full rounded-xl border pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 transition-shadow" />
                                </div>
                        ...
                        <div className="rounded-2xl border bg-card p-5 shadow-sm space-y-4">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide">Нэвтрэх нууц үг</h2>
                            </div>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        <input type={showPass ? 'text' : 'password'}
                                            ...
                                            className="border-input bg-background w-full rounded-xl border px-4 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 transition-shadow" />
                    ...
                    <div className="space-y-5">
                        <div className="rounded-2xl border bg-card p-5 shadow-sm space-y-5">
                            ...
                            <button type="submit" disabled={processing}
                                ...
                                {processing ? 'Хадгалж байна...' : 'Хэрэглэгч нэмэх'}
                            </button>
                            <Link href="/admin/users"
