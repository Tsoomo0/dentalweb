...
export default function TwoFactor() {
    const { masked_email, token, status } = usePage<PageProps>().props;
    const { data, setData, post, processing, errors } = useForm({ code: '', token });
    ...
    function resend() {
        ...
        setResending(true);
        router.post('/two-factor/resend', { token }, {
            preserveState: true,
    ...
    return (
        <>
            <Head title="Нэвтрэлтийн баталгаажуулалт" />
            ...
            <style>{`
                ...
                input:-webkit-autofill { -webkit-box-shadow:0 0 0 1000px #0d1117 inset !important; -webkit-text-fill-color:#f1f5f9 !important; }
            `}</style>
            ...
            <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#0d0d1a] px-4">
                ...
                <div className="relative z-10 w-full max-w-md animate-fade-up">
                    ...
                    <div className="rounded-3xl p-8" style={{ background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.1)' }}>
                        ...
                        <div className="mb-6 flex flex-col items-center gap-4">
                            ...
                            <div className="text-center">
                                <h1 className="text-2xl font-black text-white">2 алхамт баталгаажуулалт</h1>
                        ...
                        {/* Status */}
                        {status && (
                            <div className="mb-4 flex items-center gap-2 rounded-xl border border-blue-500/30 bg-blue-500/10 px-4 py-3 text-sm text-blue-400">
                        ...
                        <form onSubmit={submit} className="space-y-6">
                                        ...
                                        <input
                                            ...
                                            className={`digit-input size-12 rounded-2xl border text-center text-xl font-black text-white outline-none transition-all
                                                ${d
                                                    ...
                                                    : 'border-white/10 bg-white/5 focus:border-blue-500/60 focus:bg-blue-500/5'
                                                }`}
                                        />
                                    ))}
                                </div>
                            ...
                            <button type="submit" disabled={processing || !filled}
                                className="group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-xl py-4 text-sm font-bold text-white transition-all hover:shadow-lg hover:shadow-blue-500/30 disabled:opacity-50"
                                ...
                                {processing ? 'Шалгаж байна...' : 'Нэвтрэх'}
                            </button>
                        </form>
                        ...
                        <div className="mt-5 text-center">
                            ...
                            <button
                                ...
                                className="mt-1.5 inline-flex items-center gap-1.5 text-sm font-semibold text-blue-400 hover:text-blue-300 transition-colors disabled:text-white/30 disabled:cursor-not-allowed"
                            >
                    ...
                    <p className="mt-5 text-center text-xs text-white/20">
                        Код 10 минутын дараа хугацаа дуусна · 5 буруу оролдлогоос хэтэрвэл цуцлагдана
                    </p>
                </div>
            </div>
        </>
