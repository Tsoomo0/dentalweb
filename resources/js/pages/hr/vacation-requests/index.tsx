        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-3 p-4 md:p-5">
                ...
                <HrPanel
                    ...
                    subtitle="Ажилтнуудын ээлжийн амралтын хүсэлт, үлдсэн хоног"
                    actions={
                        <HrGhostButton icon={FileSpreadsheet} href="/hr/vacation-requests/export-excel" title="Excel татах">Excel</HrGhostButton>
                    }
                    tabs={
                        <HrTabs
                            tone="sky"
                ...
                <HrListCard className="overflow-hidden">
                    {filtered.length === 0 ? (
                        <div className="flex flex-col items-center gap-2 py-16 text-center">
                            ...
                            <p className="mt-1 text-sm font-semibold text-foreground">Ээлжийн амралтын хүсэлт байхгүй байна</p>
