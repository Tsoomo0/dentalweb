...
@section('title', 'Урамшууллын задаргаа')

@section('header')
<div class="header header-purple">
    <div class="header-icon">🏅</div>
    <h1>Урамшууллын задаргаа</h1>
...
@section('content')
    ...
    <div class="amount-card amount-card-purple" style="margin-bottom:26px;">
    ...
    @php
        $criteria = \App\Models\HR\ReceptionBonusEntry::CRITERIA;
    @endphp
    ...
    <div class="btn-block">
        <a href="{{ url('/my/reception-bonus') }}" class="btn btn-purple">
            Дэлгэрэнгүй харах →
        </a>
    </div>
@endsection
